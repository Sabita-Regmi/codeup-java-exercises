...
//        Inside of shapes, create a class named CircleApp that promts the user for the radius of the circle using your Input class, creates a Circle object, and displays the circumference and area. (Note that you will need to import your Input class.)
//
